...
[Jupyter Notebook](https://lancejnelson.github.io/PH150/jupyter/L2-Propgation_of_UncertaintyI.ipynb)
...
3. Understand what a derivative is and how to use it to calculate uncertainties.
...
plt.show()
```
To find the function that gives the slope of another function we can follow a set of mathematical rules. One of the most common rules is the power rule which applies to polynomial functions.  Specifically, if $f(x) = a + bx + cx^2 + dx^2 + \dots = \sum_n a_n x^n$, then 
