...
![](https://lancejnelson.github.io/PH150/figures/measurement.png){width=50%}
...
measurement agrees well with an accepted standard. The figure below illustrates this concept.  The blue dots fall in a pretty tight range but are far from the intended target.  Hence they represent high precision but low accuracy. Having all of your measurements offset from the true value is called having a *systematic error*.  There is no way to detect a systematic error by gathering data; it must be discovered by other means. The opposite can be said of the red dots.  They are centered at the target, but have large spread.

![Meter Stick](https://lancejnelson.github.io/PH150/figures/precise-accurate.png){width=50%}
